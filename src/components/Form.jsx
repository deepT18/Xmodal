      ...
      <div className="body" onClick={(e) => {
        ...
        <form onSubmit={validationChecks}>
          ...
          <>
            ...
            <input onChange={(e) => setFormData({ ...formData, name: e.target.value })} value={formData.name} name="name" />
          </>
          <>
            <label htmlFor="email"><strong>Email:</strong></label>
            <input onChange={(e) => setFormData({ ...formData, email: e.target.value })} value={formData.email} name="email" />
          </>
          <>
            <label htmlFor="number"><strong>Number:</strong></label>
            <input onChange={(e) => setFormData({ ...formData, number: e.target.value })} value={formData.number} name="number" />
          </>
          <>
            <label htmlFor="dob"><strong>Date of Birth:</strong></label>
            <input onChange={(e) => setFormData({ ...formData, dob: e.target.value })} value={formData.dob} name="dob" type="date" />
          </>
